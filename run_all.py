...
if not opt.test:
    ...
    ITERATIONS = 1
    EXPERIMENTS = [
                    Experiment_ACGAN(epochs=1, batch_size=1000, verbose=True, device=device),
                    Experiment_CGAN(epochs=1, batch_size=1000, verbose=True, device=device),
                    Experiment_WGAN_GP(epochs=1, batch_size=1000, verbose=True, device=device),
                    Experiment_WGAN(epochs=1, batch_size=1000, verbose=True, device=device),
                    ]
